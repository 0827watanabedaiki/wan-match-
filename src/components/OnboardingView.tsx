...
const BREEDS = [
  ...
  'ミニチュアプードル', 'ブリュッセルグリフォン', 'プチバセットグリフォンバンデーン',
  'ロシアントイ', 'イングリッシュトイスパニエル',
  'ジャパニーズチン', 'ラサアプソ', 'チベタンスパニエル', 'チベタンテリア',
  ...
  'カネコルソ', 'ナポリタンマスティフ', 'ブルマスティフ', 'マスティフ',
  'ロデシアンリッジバック', 'ヴィズラ', 'ワイマラナー',
  'アイリッシュウォータースパニエル', 'クランバースパニエル',
  // ハイブリッド・デザイナー犬
  'ゴールデンドゥードル', 'オーストラリアンラブラドゥードル',
  'ラブラドゥードル', 'コッカプー', 'マルプー', 'シュナプー',
  'ポンポン', 'チワプー', 'ポメプー',
  // MIX・その他
